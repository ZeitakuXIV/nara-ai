...
export default function Chatbot() {
  ...
  return (
    <div className="h-[100dvh] flex flex-col bg-nara-light relative overflow-hidden pt-[env(safe-area-inset-top,1rem)] pb-[env(safe-area-inset-bottom,1rem)]">
      ...
      <header className="px-6 py-4 flex items-center justify-between z-20 shrink-0">
        <div className="flex items-center gap-3">
           ...
           <div>
              ...
              <span className="text-[10px] text-nara-emerald font-bold uppercase tracking-widest">Inference Engine Active</span>
           </div>
        </div>
      ...
      {/* Input Section - Positioned above Bottom Nav */}
      ...
      {/* RESTORED: Bottom Navigation for Chat Page */}

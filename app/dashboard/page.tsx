  ...
  return (
    <div className="app-content bg-nara-light">
      ...
      <header className="px-6 pt-8 pb-4 flex justify-between items-end z-10 shrink-0">
        <div>
           <p className="text-[10px] font-black text-nara-hunter uppercase tracking-[0.2em] mb-1 opacity-60">Act Layer • Plan</p>
        ...
        <div className="space-y-4">
           ...
           {selectedDay.meals.length > 0 ? (
                ...
                {selectedDay.meals.map((meal, idx) => (
                   ...
                   >
                      ...
                      <div className="absolute top-6 left-6 flex gap-2">
                         ...
                         <div className="bg-nara-hunter/80 backdrop-blur-md px-3 py-1.5 rounded-full border border-nara-hunter/40 text-[10px] text-white font-black">{meal.calories} KCAL</div>
                      </div>
             ...
             <div className="glass-container p-12 flex flex-col items-center justify-center text-center bg-white/20">
                ...
                <p className="text-sm text-nara-muted leading-relaxed max-w-[220px]">Calibrating local recipes for your signature biometrics...</p>
             </div>
           )}
        </div>
            ...
            <div className="glass-container p-8 grid grid-cols-2 gap-4">
               ...
               <div className="h-32 w-full relative flex items-center justify-center">
                  ...
                  <div className="absolute flex flex-col items-center">
                     <span className="text-lg font-black text-nara-hunter">{currentMeal.calories}</span>
                     <span className="text-[8px] font-black uppercase text-slate-400 tracking-[0.2em]">KCAL</span>
                  </div>
               </div>
            </div>

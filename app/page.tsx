  ...
  return (
    <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 relative overflow-hidden bg-mesh-gradient">
      ...
      >
        ...
        <div className="flex items-center gap-1.5 text-nara-emerald font-bold text-[11px] uppercase tracking-[0.2em] mb-4 bg-nara-emerald/10 px-3 py-1 rounded-full border border-nara-emerald/20">
      ...
      <footer className="mt-auto pt-12 text-[10px] text-slate-400 font-bold uppercase tracking-[0.3em] z-10 opacity-60">
